...
import com.jmm.www.calculator.ExpressionHandler.Constants;
import com.jmm.www.calculator.ExpressionHandler.ExpressionHandler;
...
//            "方程式配平", "分子量计算", "亲戚关系计算", "大写数字", "汇率转换", "单位转换"};
    ...
    final private String[] FUNCTION_LIST = {"科学计算", "大数计算", "进制转换", "大写数字"};
...
//        setGodMode(isGodMode);
        ...
        godMode = menu.add("帮助").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(MainActivity.this);
                dialog.setTitle("帮助")
